...
const useClapAnimation = ({ clapEl, countEl, clapTotalEl }) => {
  ...
  useLayoutEffect(() => {
    ...
    const tlDurantion = 300;

    const scaleButton = new mojs.Html({
      el: clapEl,
      duration: tlDurantion,
      scale: { 1.3: 1 },
...
/**
 *  Cutom hook for getting previou prop/state
 *
 */
...
const Usage = () => {
  const [timesClapped, seTimeClapped] = useState(0);
